...
def _preprocess_data(**kwargs):
    data_path = "/Users/nikhilanand/BDLProject/data"
...
def _unzip_data(**kwargs):
    with ZipFile("/Users/nikhilanand/BDLProject/data/train.zip", 'r') as zObject: 
        zObject.extractall(path="/Users/nikhilanand/BDLProject/data")

with DAG("keypoints_dag", start_date=datetime(2022,1,1),
         schedule_interval="@daily", catchup=False) as dag:
    print("curl -o data/training.csv \"" + training_csv_url + "\"")
    fetch_data = BashOperator(task_id="fetch_data",bash_command="curl -o /Users/nikhilanand/BDLProject/data/train.zip \"" + training_csv_url + "\"")
